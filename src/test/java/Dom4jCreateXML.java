...
//        createMapper(User.class,directoryPath, Arrays.asList(INSERT,UPDATE,DELETE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(BaiduUser.class,directoryPath, Arrays.asList(INSERT,UPDATE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
        createMapper(User.class,directoryPath, Arrays.asList(INSERT,UPDATE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(UserInfo.class,directoryPath, Arrays.asList(INSERT,UPDATE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(BeanRecord.class,directoryPath, Arrays.asList(INSERT,LIST,GET_COUNT,GET_MAX_ID));
//        createMapper(JifenRecord.class,directoryPath, Arrays.asList(INSERT,LIST,GET_COUNT,GET_MAX_ID));
//        createMapper(SeeRecord.class,directoryPath, Arrays.asList(INSERT,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(ExtendRecord.class,directoryPath, Arrays.asList(INSERT,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(LastLoginRecord.class,directoryPath, Arrays.asList(INSERT,UPDATE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(SignInRecord.class,directoryPath, Arrays.asList(INSERT,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(SiteSetting.class,directoryPath,Arrays.asList(INSERT,UPDATE,FIND_BY_ID));
//        createMapper(RechargeRecord.class,directoryPath,Arrays.asList(INSERT,LIST,GET_COUNT,GET_MAX_ID));
//        createMapper(FreeBeanSetting.class,directoryPath,Arrays.asList(INSERT,UPDATE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(FreeBeanRecord.class,directoryPath,Arrays.asList(INSERT,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(Power.class,directoryPath,Arrays.asList(INSERT,UPDATE,LIST,GET_COUNT,GET_MAX_ID,FIND_BY_ID));
//        createMapper(GrowRecord.class,directoryPath,Arrays.asList(INSERT,LIST,GET_COUNT,GET_MAX_ID));
    }
    ...
    private static String testDirectoryPath = "D:" + File.separator + "workspace" + File.separator + "hy" + File.separator + "src" + File.separator + "test" + File.separator
            + "resources" + File.separator + "mapper";
    private static String directoryPath = "D:" + File.separator + "workspace" + File.separator + "hy" + File.separator + "src" + File.separator + "main" + File.separator
            + "resources" + File.separator + "mapper";
