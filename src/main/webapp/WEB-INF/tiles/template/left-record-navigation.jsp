    ...
    <div class="menu-list">
        <ul id="menu-content" class="menu-content collapse out">
            <li ng-class="{active:leftNav.index==1}">
                <a href="${pageContext.request.contextPath}/manager/product/upload">
                    <i class="fa fa-send fa-lg"></i>表格上传
                </a>
            </li>
            <li ng-class="{active:leftNav.index==2}">
                <a href="${pageContext.request.contextPath}/manager/managerLoginLog/list">
                    <i class="fa fa-list fa-lg"></i>登录记录
                </a>
            </li>
            <li ng-class="{active:leftNav.index==3}">
                <a href="${pageContext.request.contextPath}/manager/siteInfo/edit">
